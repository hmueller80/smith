...
import at.ac.oeaw.cemm.bsf.barcode.AdapterSequence;
...
import at.ac.oeaw.cemm.lims.persistence.entity.BarcodeKitPK;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (String kit : kits) {
                ...
                AdapterSequence kitObj = (AdapterSequence) kitClass.newInstance();
